...
> 4. Doplň název banky v sekci 4.6, pokud je relevantní.
> 5. Doplň zvolenou e-mailovou službu v sekci 4.5.
> 6. Cookie banner na web není třeba, pokud nenasazuješ analytiku.
>
> **Změny ve verzi 3.0 (Stripe-friendly):**
...
> - Mollie odstraněna, ponechán jen Stripe
> - Self-custody krypto nahrazeno službou NOWPayments OÜ
> - Hosting GitHub Pages → Cloudflare Pages + Workers + D1 + R2 (sekce 4.4)
...
The Platform is a personal initiative through which the Operator (a private individual based in the Czech Republic) accepts voluntary gifts from people who wish to support him online. **No products or services are sold**;
...
- **Purpose:** Website hosting, backend logic, donation database, encrypted
  backups, DNS, DDoS protection, geographic IP detection
- **Location:** Global CDN with EU routing for EU visitors; data at rest in EU
  regions where configured
- **Legal safeguards:** EU-US Data Privacy Framework; Cloudflare Data Processing
  Addendum (DPA) signed with Standard Contractual Clauses
- **Their Privacy Policy:** https://www.cloudflare.com/privacypolicy/

### 4.5. Email delivery — [DOPLŇ, např. Resend / Postmark / MailerLite]
...
Platform, please contact us at info@onedollarguy.com and we will delete the
related data.
...
Platforma je osobní iniciativa, jejímž prostřednictvím Provozovatel (soukromá
fyzická osoba se sídlem v České republice) přijímá dobrovolné dary od lidí,
kteří jej chtějí podpořit online. **Neprodává se žádné zboží ani služby**;
osobní údaje jsou zpracovávány pouze v rozsahu nezbytně nutném pro zpracování
darů, splnění zákonných povinností a bezpečný provoz Platformy.
...
- **Účel:** Hostování webu, backendová logika, databáze darů, šifrované
  zálohy, DNS, ochrana proti DDoS, geografická detekce IP
...
### 4.5. E-mailová služba — [DOPLŇ, např. Resend / Postmark / MailerLite]
