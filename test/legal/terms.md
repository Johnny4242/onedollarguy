...
> 3. Ověř, že kontaktní email info@onedollarguy.com existuje a je monitorován.
...
>
> **Změny ve verzi 3.0 (Stripe-friendly úpravy):**
> - Adresa: Subákova 34/8, 674 01 Třebíč
> - Email: info@onedollarguy.com
> - Slovo "social experiment" nahrazeno "personal initiative" / "osobní iniciativa"
> - Mollie odstraněna ze seznamu poskytovatelů (jen Stripe)
> - Self-custody krypto nahrazeno NOWPayments OÜ
...
The Platform is a personal initiative through which the Operator (a private individual based in the Czech Republic) shares his life and creative work online and accepts voluntary symbolic gifts from people who wish to support him. **No products or services
...
- **Operator**: Jan Pisk, residing at Subákova 34/8, 674 01 Třebíč,
  Czech Republic, business ID (IČO): **XXXXXXXX**, contact: info@onedollarguy.com.
...
- **Stripe Payments Europe, Ltd.** (Ireland) — card payments, Apple Pay, Google Pay,
  Click to Pay, and selected regional payment methods
- **PayPal (Europe) S.à r.l. et Cie, S.C.A.** (Luxembourg) — PayPal account payments
  and PayPal-processed card payments
- **NOWPayments OÜ** (Estonia, EU) — cryptocurrency payment processing for Bitcoin,
  Ethereum, Tether (USDT), USD Coin (USDC), and other supported cryptocurrencies
...
the respective PCI-DSS-compliant payment providers (or, in the case of NOWPayments,
by the licensed cryptocurrency processor).

**4.3. Cryptocurrency contributions.** Contributions in cryptocurrency are processed
by NOWPayments OÜ. While NOWPayments provides a 15-minute exchange rate lock-in,
contributions are final and irreversible by nature of blockchain technology once
confirmed. The Operator cannot reverse a confirmed blockchain transaction under
any circumstances. Contributors are solely responsible for sending funds to the
correct address and amount displayed by NOWPayments at the time of payment.
...
info@onedollarguy.com within 30 days — such errors will be corrected.
...
contact the Operator in advance at info@onedollarguy.com to coordinate.
...
Vítejte na stránkách ODG — One Dollar Guy ("Platforma"). Tyto Podmínky užití
("Podmínky") upravují váš přístup k Platformě a její využívání, provozované Janem
Piskem ("Provozovatel").

Platforma je osobní iniciativa, jejímž prostřednictvím Provozovatel (soukromá fyzická osoba se sídlem v České republice) sdílí svůj život a tvorbu online a přijímá dobrovolné symbolické dary od lidí, kteří jej chtějí podpořit.
...
- **Provozovatel**: Jan Pisk, bytem Subákova 34/8, 674 01 Třebíč,
  Česká republika, IČO: **XXXXXXXX**, kontakt: info@onedollarguy.com.
...
- **Stripe Payments Europe, Ltd.** (Irsko) — platby kartou, Apple Pay, Google Pay,
  Click to Pay a vybrané regionální platební metody
- **PayPal (Europe) S.à r.l. et Cie, S.C.A.** (Lucembursko) — platby přes PayPal
  účet a karty zpracovávané prostřednictvím PayPal
- **NOWPayments OÜ** (Estonsko, EU) — zpracování plateb v kryptoměnách
  pro Bitcoin, Ethereum, Tether (USDT), USD Coin (USDC) a další podporované
  kryptoměny
...
odpovídajícími standardu PCI-DSS (případně, v případě NOWPayments, licencovaným
zpracovatelem kryptoměnových plateb).

**4.3. Příspěvky v kryptoměnách.** Příspěvky v kryptoměnách jsou zpracovávány
službou NOWPayments OÜ. Ačkoli NOWPayments poskytuje 15minutovou fixaci kurzu,
po potvrzení blockchainové transakce jsou příspěvky vzhledem k povaze
...
odpovědný za odeslání prostředků na správnou adresu a ve správné výši zobrazené
službou NOWPayments v okamžiku platby.
...
info@onedollarguy.com do 30 dnů — takové chyby budou opraveny.
...
vyzváni, aby předem kontaktovali Provozovatele na info@onedollarguy.com.
